...
namespace f1project.data.Migrations
{
    ...
    [Migration("20211020110323_ColumnNameUpdateByID3")]
    partial class ColumnNameUpdateByID3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("f1project.entity.Concrete.PostDriver", b =>
                {
                    b.Property<int>("PdDriverId")
                        .HasColumnType("int");

                    b.Property<int>("PdPostId")
                        .HasColumnType("int");

                    b.HasKey("PdDriverId", "PdPostId");
            ...
            modelBuilder.Entity("f1project.entity.Concrete.PostTeam", b =>
                {
                    b.Property<int>("PtTeamId")
                        .HasColumnType("int");

                    b.Property<int>("PtPostId")
                        .HasColumnType("int");

                    b.HasKey("PtTeamId", "PtPostId");
            ...
            modelBuilder.Entity("f1project.entity.Concrete.PostDriver", b =>
                {
                    b.HasOne("f1project.entity.Concrete.F1Driver", "Driver")
                        ...
                        .HasForeignKey("PdDriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("f1project.entity.Concrete.Post", "Post")
                        .WithMany("PostsDrivers")
                        .HasForeignKey("PdPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
